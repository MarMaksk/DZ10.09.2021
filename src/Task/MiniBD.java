...
public class MiniBD {
    public static List<Product> products() throws BarcodeException, PriceProductException, NameProductException {
        List<Product> baseProd = new ArrayList(Arrays.asList(
                ...
                new Product("Better", 1, 0, UnitType.kilo, "1000000000007", ActionType.NO_ACTION),
                new Product("Meter", 2, 30, UnitType.liter, "1000000000008", ActionType.FOR_SECOND_PRODUCT),
